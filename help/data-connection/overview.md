...
| [Adobe [!DNL Journey Optimizer]](https://experienceleague.adobe.com/docs/journey-optimizer/using/get-started/get-started.html) | Campagneorchestratie langs kanalen | **Op gedrag gebaseerde reizen**: Een klant die twee jaar geleden een mobiele telefoon heeft gekocht, kan worden aangewezen voor het kopen van een nieuwe mobiele telefoon omdat hij of zij nu waarschijnlijk op zoek is naar een nieuwe mobiele telefoon. Ook, kunnen de gepersonaliseerde campagnes en de promoties worden gebruikt om dergelijke klanten te richten. [!DNL Journey Optimizer] kan de functionaliteit voor e-mail en SMS gebruiken om deze klanten te bereiken. De gegevens van de Historische Orde samen met gedragsgegevens kunnen worden gebruikt om tendensen te identificeren. Een klant die in het verleden een artikel met een bepaalde configuratie heeft gekocht en nu het zelfde product opnieuw probeert aan te schaffen, kan zijn koopreis door hen gemakkelijk zicht/toegang tot de zelfde productconfiguraties te geven verbeteren.<br> **Personalisatie**: Met toegang tot klantprofielinformatie, [!DNL Journey Optimizer] kunnen zeer gepersonaliseerde reizen ontgrendelen, zodat handelaren de klanten op verschillende kanalen kunnen bereiken.<br> **Nieuw profiel gemaakt**: Welkomste-mails en promotieactiviteiten kunnen nieuwe klanten stimuleren en beïnvloeden bij hun winkelreizen.<br> **Profiel verwijderd**: Merchants kunnen ervoor kiezen geen speciale e-mails meer te verzenden naar klanten die hun account hebben gesloten. De handelaren kunnen ook campagnes bouwen om verloren klanten terug te winnen. |

## Gegevens van Experience Platform terugbrengen in de handel

Verstuur uw gegevens van de Handel naar het Experience Platform gebruikend [!DNL Data Connection] de uitbreiding is één kant van de mogelijkheden van de Handel om gegevens te delen. De andere zijde, die een facultatieve uitbreiding is, wordt genoemd [Audience Activation](https://experienceleague.adobe.com/docs/commerce-admin/customers/audience-activation.html). Met deze extensie kunt u een publiek opbouwen in Real-Time CDP en dit soort publiek inzetten in uw winkel voor handel om de regels en dynamische blokken voor de prijs van winkelwagentjes te informeren.
