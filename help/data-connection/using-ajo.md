...
Dit specifieke geval van gebruik concentreert zich op het creëren van een verlaten karretje-e-mail gebruikend gegevens van uw [!DNL Commerce] instantie en het verzenden van het naar Adobe [!DNL Journey Optimizer].
...
>[!IMPORTANT]
>
>Voor demonstratiedoeleinden gebruikt u de [!DNL Commerce] sandbox-omgeving, zodat u de productiegebeurtenisgegevens niet verwatert met de gegevens van de storefront- en back office-gebeurtenis die u naar het Experience Platform verzendt.

### Vereisten

Voordat u met deze stappen begint, moet u controleren of:

- U bent provisioned om Adobe [!DNL Journey Optimizer] te gebruiken. Als u niet zeker bent, raadpleegt u uw systeemintegrator of ontwikkelingsteam dat projecten en omgevingen beheert.
- U [ installeerde ](install.md) en [ vormde ](connect-data.md) de [!DNL Data Connection] uitbreiding in [!DNL Commerce].
- U [ bevestigde ](connect-data.md#confirm-that-event-data-is-collected) dat uw [!DNL Commerce] gebeurtenisgegevens bij de rand van het Experience Platform aankomen.
...
1. Meld u aan of maak een account in uw [!DNL Commerce] sandbox-omgeving.
   ...
   Als de extensie [!DNL Data Connection] is geïnstalleerd en geconfigureerd, worden deze accountgegevens als een profiel naar het Experience Platform verzonden.

1. Controleer of de gegevens van uw gebruikersaccount worden weergegeven in de sectie **[!UICONTROL Profile]** van het Experience Platform.
