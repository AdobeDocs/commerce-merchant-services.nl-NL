...
De [!UICONTROL Payment Action] instellen in uw [!UICONTROL Payment Settings] configuratie—Willekeurig `Authorize` of `Authorize and Capture`—bepaalt de [basisworkflow voor restitutie](https://docs.magento.com/user-guide/sales/credit-memos.html#refund-workflow){target=&quot;_blank&quot;} voor bestellingen.
