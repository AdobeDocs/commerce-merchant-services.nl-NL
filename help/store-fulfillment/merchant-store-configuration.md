...
| **[!UICONTROL Enable Ship to Store]**</br>`Extension Attribute: [!DNL allow_ship_to_store]` | Vorm schip-aan-opslagmogelijkheden op het bronniveau. Zie de klasse [Algemene configuratie](enable-general.md) optie, **[!UICONTROL Enable Ship To Store]**. | Algemeen | Nee |
| **[!UICONTROL Enable Ship From Store]**</br>`Extension Attribute: [!DNL use_as_shipping_source]` | Vorm schip-van-opslag mogelijkheden op het bronniveau. Zie de klasse [Algemene configuratie](enable-general.md) optie, [!UICONTROL Enable Ship From Store] | Algemeen | Nee |
