...
Talen hebben verschillende sets regels voor grammatica: hoe woorden worden gescheiden, bijvoorbeeld werkwoorden en synoniemen.
Het plaatsen van de Taal zorgt ervoor dat de correcte reeks regels op het indexerende mechanisme worden toegepast.

De taalinstellingen moeten worden ingesteld op de primaire taal van de catalogus.
