...
- Als uw winkel kleding verkoopt, `More like this` aanbevelingen kunnen genderspecifieke producten voorstellen die niet overeenkomen met het geslacht van het product dat wordt bekeken. Overweeg dit soort aanbevelingen alleen te gebruiken voor niet-kledingcategorieën.
...
1. Op de _Beheerder_ zijbalk, ga naar **Marketing** > _Aanbiedingen_ > **Product Recommendations** om de _Product Recommendations_ dashboard.
...
In het volgende voorbeeld wordt het _Visuele gelijkenis_ aanbeveling-eenheid _Clamber Watch_:
