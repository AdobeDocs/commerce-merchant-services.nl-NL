...
Wanneer u [ een SaaS gegevensruimte ](../landing/saas.md#saas-configuration) voor Recommendations vormt, verzamelt de SaaS gegevensruimte catalogusgegevens en opslag-gedrag gegevens. [ Adobe Sensei ](https://www.adobe.com/sensei.html) analyseert dat de gegevens en de productverenigingen die worden gebruikt om het Recommendations van het Product te dienen.
