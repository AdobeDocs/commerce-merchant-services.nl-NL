...
![Nieuw](../assets/new.svg) Product Recommendations heeft nu een GraphQL [`recommendations`](https://developer.adobe.com/commerce/webapi/graphql/schema/product-recommendations/queries/recommendations/) query.
